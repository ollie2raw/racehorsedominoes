...
const publicState_1 = require("./game/publicState");
    ...
    for (const socketId of sockets) {
        ...
        if (socket) {
            ...
            socket.emit("state:update", {
                state: (0, publicState_1.getVisibleGameState)(room.state, socketId),
                legalMoves,
                canDraw,
            });
        }
    ...
    socket.on("room:join", (code, cb) => {
        ...
        try {
            ...
            cb({
                ...
                state: room.state ? (0, publicState_1.getVisibleGameState)(room.state, socket.id) : null,
            });
        }
        catch (err) {
            const message = err instanceof Error ? err.message : "unknown error";
